...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-na3cxqm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-na3cxqm.containers.anotherwebservice.com/
...
```
git clone git@github.com:lsscodes/container-na3cxqm.git
cd container-na3cxqm
```
...
```
docker attach container-na3cxqm
```
